    ...
    <section id="faq" className="max-w-[1440px] mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-16 lg:py-20">
      ...
      <div className="max-w-4xl mx-auto space-y-3 sm:space-y-4">
        {filteredFAQs.map((faq) => (
          <Card 
            key={faq.id} 
            className={`border-white/10 transition-all duration-300 cursor-pointer ${
          ...
          >
            <div>
              <div className="flex items-start justify-between gap-3 sm:gap-4">
                <div className="flex items-start gap-2 sm:gap-3 flex-1">
                  ...
                  <div className="flex-1">
                    <h4 className="text-white mb-2 text-sm sm:text-base lg:text-lg">{faq.question}</h4>
                    <span className={`text-xs px-2 py-1 rounded ${getCategoryColor(faq.category)} bg-white/5`}>
              ...
              {activeId === faq.id && (
                <div className="mt-3 sm:mt-4 pt-3 sm:pt-4 border-t border-white/10 animate-fadeIn">
      ...
      <div className="mt-8 sm:mt-10 lg:mt-12 text-center px-4">
        <Card className="max-w-2xl mx-auto border-[#FFD700]/20 bg-gradient-to-br from-[#FFD700]/5 to-transparent">
          <div className="text-center">
            <h3 className="text-white mb-2 sm:mb-3 text-lg sm:text-xl lg:text-2xl">Still have questions?</h3>
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-3 sm:gap-4">
              ...
              <a 
                ...
                className="w-full sm:w-auto px-4 sm:px-6 py-2.5 sm:py-3 glass-card border border-white/10 text-white rounded-xl hover:border-[#FFD700]/50 transition-all duration-300 text-sm sm:text-base"
              >
                Call Support
              </a>
            </div>
