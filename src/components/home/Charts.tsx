...
export function Charts({ theme }: ChartsProps) {
  ...
  return (
    <section id="charts" className="max-w-[1440px] mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-16 lg:py-20">
      ...
      <Card className="border-[#FFD700]/20">
        {/* Chart Controls */}
        <div className={`flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 sm:gap-0 mb-6 sm:mb-8 pb-4 sm:pb-6 border-b ${
        ...
        <div className="mb-6">
          <div className="flex items-baseline gap-4">
            <span className={`text-4xl ${theme === 'dark' ? 'text-white' : 'text-black'}`}>
