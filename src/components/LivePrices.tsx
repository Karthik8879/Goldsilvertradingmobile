...
export function LivePrices() {
  ...
  return (
    <section id="live-prices" className="max-w-[1440px] mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-16 lg:py-20">
      <div className="text-center mb-8 sm:mb-10 lg:mb-12">
        <div className="inline-flex items-center gap-2 mb-3 sm:mb-4">
          <Radio className="w-4 h-4 sm:w-5 sm:h-5 text-[#FFD700] animate-pulse" />
          <span className="text-xs sm:text-sm text-white/60">Live Market Data</span>
        </div>
        <h2 className="text-white mb-3 sm:mb-4 text-2xl sm:text-3xl lg:text-4xl">Live Market Prices</h2>
        <p className="text-white/60 text-sm sm:text-base lg:text-lg px-4">Real-time bullion market rates updated every second</p>
      </div>
          ...
          <Card key={price.id} glowOnHover className="relative overflow-hidden">
            ...
            <div className="relative space-y-3 sm:space-y-4">
              <div className="flex items-center justify-between">
                <span className="text-sm sm:text-base text-white/80">{price.name}</span>
                {price.isSpot && <Badge variant="spot">SPOT</Badge>}
              </div>
              
              <div>
                <div className="flex items-baseline gap-2">
                  <span className="text-xs sm:text-sm text-white/60">{price.currency}</span>
