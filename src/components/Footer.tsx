...
export function Footer() {
  return (
    <footer className="border-t border-white/10 mt-12 sm:mt-16 lg:mt-20">
      <div className="max-w-[1440px] mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-14 lg:py-16">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 sm:gap-10 lg:gap-12 mb-8 sm:mb-10 lg:mb-12">
          ...
          <div>
            ...
            <div className="flex items-center gap-2 sm:gap-3">
              <a href="#" className="w-9 h-9 sm:w-10 sm:h-10 rounded-lg bg-white/5 hover:bg-white/10 flex items-center justify-center text-white/60 hover:text-[#FFD700] transition-all">
          ...
          {/* Quick Links */}
          <div>
            <h4 className="text-white mb-4 sm:mb-6 text-base sm:text-lg">Quick Links</h4>
            <ul className="space-y-2 sm:space-y-3">
              {['About Us', 'Live Rates', 'Products', 'Charts', 'News', 'Contact'].map((link) => (
                <li key={link}>
                  <a href="#" className="text-white/60 hover:text-[#FFD700] transition-colors text-sm sm:text-base">
                    {link}
                  </a>
                </li>
              ))}
          ...
          {/* Services */}
          <div>
            <h4 className="text-white mb-4 sm:mb-6 text-base sm:text-lg">Services</h4>
            <ul className="space-y-2 sm:space-y-3">
          ...
          {/* Contact */}
          <div>
            <h4 className="text-white mb-4 sm:mb-6 text-base sm:text-lg">Contact Details</h4>
            <ul className="space-y-3 sm:space-y-4">
              <li className="flex items-start gap-2 sm:gap-3">
                ...
                <div>
                  ...
                  <a href="mailto:support@goldjar.com" className="text-white hover:text-[#FFD700] transition-colors text-sm sm:text-base">
                    support@goldjar.com
                  </a>
                </div>
              </li>
              <li className="flex items-start gap-2 sm:gap-3">
                ...
                <div>
                  ...
                  <a href="tel:+911234567890" className="text-white hover:text-[#FFD700] transition-colors text-sm sm:text-base">
                    +91 123 456 7890
                  </a>
                </div>
              </li>
              <li className="flex items-start gap-2 sm:gap-3">
                ...
                <div>
                  <p className="text-white/60 text-xs sm:text-sm mb-1">Address</p>
        ...
        <div className="glass-card rounded-2xl p-4 sm:p-6 lg:p-8 mb-8 sm:mb-10 lg:mb-12">
          <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 sm:gap-6">
            <div>
              <h4 className="text-white mb-2 text-base sm:text-lg lg:text-xl">Trade on the Go</h4>
              <p className="text-white/60 text-sm sm:text-base">Download our mobile app for seamless trading</p>
            </div>
            <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-2 sm:gap-3 lg:gap-4 w-full sm:w-auto">
              <button className="px-4 sm:px-6 py-2.5 sm:py-3 bg-white/5 hover:bg-white/10 border border-white/10 rounded-lg text-white transition-all flex items-center justify-center gap-2 text-sm sm:text-base">
        ...
        <div className="pt-6 sm:pt-8 border-t border-white/10">
          <div className="flex flex-col sm:flex-row items-center justify-between gap-4 sm:gap-6">
            ...
            <div className="flex flex-wrap items-center justify-center gap-4 sm:gap-6 lg:gap-8">
              <a href="#" className="text-white/60 hover:text-[#FFD700] text-xs sm:text-sm transition-colors">
                Privacy Policy
              </a>
              <a href="#" className="text-white/60 hover:text-[#FFD700] text-xs sm:text-sm transition-colors">
                Terms of Service
          ...
          <div className="mt-4 sm:mt-6 p-3 sm:p-4 bg-white/5 rounded-lg border border-white/10">
            <p className="text-white/60 text-xs leading-relaxed">
              <strong className="text-white">Disclaimer:</strong> Trading in gold and silver involves market risks. Past performance is not indicative of future results. 
